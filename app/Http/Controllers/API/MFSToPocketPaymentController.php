...
class MFSToPocketPaymentController extends Controller
{
    //To get all the MFS To Wallet payment data...
    public function getMFSToPocketPaymentData()
    {
        ///To get current user...
        $userId = CurrentUser::getUserId();

        //To get all the account payment data...
        $accountPaymentData = AccountPayment::orderBy('id','DESC')->where('payment_type', 'MFS To Wallet')->where('user_id', $userId)
    ...
    // To MFS To Wallet payment...
    public function mfsToPocketPayment(Request $request, $id)
    {

...
class AccountToMFSPaymentController extends Controller
{
    //To get all the account to mfs payment data...
    public function getAccountToMFSPaymentData()
    {
        ///To get current user...
        $userId = CurrentUser::getUserId();

        //To get all the account payment data...
        $accountPaymentData = AccountPayment::orderBy('id','DESC')->where('payment_type', 'Account To MFS')->where('user_id', $userId)
    ...
    // To account to mfs payment...
    public function accountToMFSPayment(Request $request, $id)
    {
        $validator = Validator::make($request->all(), [

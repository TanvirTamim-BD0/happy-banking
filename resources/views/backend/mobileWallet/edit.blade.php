...
@section('title') Bank System | Mobile Wallet Update @endsection
@section('styles')
<style>
</style>
@endsection
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="align-items-center pb-2 pt-2">
                    ...
                    <span class="nav_indicator"><a href="{{route('home')}}" class="breadcump-text">Home</a> > <span
                            class="breadcump-active"> Edit</span></span>
                </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="card-body card p-3">
                                <div class="card-content custom-card-content-for-datatable pb-5 pt-2">
                                    <h2 class="card-title">Mobile Wallet Update</h2>
                                ...
                                <form class="passShowForm" action="{{route('mobile-wallet.update', $singleMobileWalletData->id)}}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="single_input">
                                                ...
                                                <input onblur="inputValidator(this.value,'warnTextName','text')"
                                                    placeholder="Mobile Wallet Name" class="form-control" type="text"
                                                    name="mobile_wallet_name" id="mobile_wallet_name" value="{{$singleMobileWalletData->mobile_wallet_name}}" required>
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="single_input">
                                                ...
                                                <input onblur="inputValidator(this.value,'warnTextComapny','text')" placeholder="Parent Comapny"
                                                    ...
                                                    value="{{$singleMobileWalletData->parent_company}}" required>
                                        ...
                                        <div class="col-12 mb-2">
                                            ...
                                            <div class="select_imgWith_preview">
                                                @if(isset($singleMobileWalletData->image) && $singleMobileWalletData->image != null)
                                                    <img id="uploadPreview" src="{{asset('backend/uploads/mobileWalletImage/'.$singleMobileWalletData->image)}}" />
                                                @else

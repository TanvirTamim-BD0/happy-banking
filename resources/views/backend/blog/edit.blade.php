...
@section('title') Bank System | Blog Update @endsection
@section('styles')
@endsection
@section('content')
  ...
  <div class="container-fluid">
    <div class="top_post d-flex align-items-center justify-content-between mb-3">
      <div class="d-flex align-items-center">
        <h3>Update Blog<span class="divider"> |</span></h3><span class="nav_indicator"><a href="./index.html">Home</a> >
          Update Blog</span>
      </div>
    </div>

    <form action="{{route('blog.update',$singleBlogData->id)}}" method="post" enctype="multipart/form-data">
      @csrf
      @method('put')
      <div class="row">
          ...
          <div class="text_input mb-3">
            <div class="form-group mb-2">
              ...
              <input onblur="inputValidator(this.value,'warnTextName','text')" required type="text" class="form-control"
                placeholder="Add title" name="title" id="title" value="{{$singleBlogData->title}}">
            ...
            <div class="form-group">
              ...
              <textarea name="description" class="form-control" id="description" cols="30"
                rows="10">{{$singleBlogData->description}}</textarea>
              ...
              <div class="row">
                ...
                <div class="col-md-12 mb-3 custom-select2-dropdown">
                  ...
                  <select id="type" class="form-control w-100" name="type" required>
                    ...
                    <option value="frontend" {{ $singleBlogData->type == 'frontend' ? 'selected' : '' }}>Frontend Blog</option>
                    <option value="faq" {{ $singleBlogData->type == 'backend' ? 'selected' : '' }}>Frontend Faq</option>
                ...
                <div class="col-md-12 mb-3 custom-select2-dropdown">
                  ...
                  <select id="blog_category_id" class="form-control w-100" name="blog_category_id" required>
                    ...
                    <option value="{{$item->id}}"
                      {{ $item->id == $singleBlogData->blog_category_id ? 'selected' : '' }}>
                ...
                <div id="card_body_5" class="card-body my-2 mb-3 position-relative">
                  <div style="width:100%; height:200px" class="select_imgWith_preview">
                    <img id="uploadPreview" src="{{asset('backend/uploads/blog/thumbnail/'.$singleBlogData->image)}}" />

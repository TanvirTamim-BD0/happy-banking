...
@section('title') Bank System | Documentation Create @endsection
@section('styles')
@endsection
@section('content')
  ...
  <div class="container-fluid">
    <div class="top_post d-flex align-items-center justify-content-between mb-3">
      <div class="d-flex align-items-center">
        <h3>Add New Documentation<span class="divider"> |</span></h3><span class="nav_indicator"><a href="./index.html">Home</a>
          > Add New Documentation</span>
      </div>
    </div>
        ...
        <div class="col-md-9 mb-3">
          ...
          <div class="text_input mb-3">
            <div class="form-group mb-2">
              ...
              <input onblur="inputValidator(this.value,'warnTextName','text')" type="text" class="form-control"
                placeholder="Add title" name="title" id="title" required>
              <span id="warnTextName" class="text-danger warn">Title is required</span>
            </div>

            <div class="form-group">
              <label class="h5" for="description">Add new Documentation</label>
              ...
              <div class="row">
                ...
                <div class="col-md-12 mb-3 custom-select2-dropdown">
                  ...
                  <select id="documentation_category_id" class="form-control w-100" name="documentation_category_id" required>
                    ...
                    <option value="{{$item->id}}">{{$item->documentation_category_name}}</option>
                    @endif
                    @endforeach
                ...
                <div id="card_body_5" class="card-body my-2 mb-3 position-relative">
                  <div style="width:100%; height:200px" class="select_imgWith_preview">
                    ...
                    <input id="uploadImage" type="file" name="image"
                      onchange="PreviewImage('uploadImage','uploadPreview');" required/>

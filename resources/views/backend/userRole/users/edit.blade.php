    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-white opacity-75">User Update</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
            ...
            <div class="card-body py-4">
                ...
                <form action="{{ route('users.update', $userData->id) }}" method="post"
                    ...
                    <div class="row">
						...
						<div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" class="form-control" name="email"
                                    ...
                                    placeholder="Product Email" required>
						...
						<div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" class="form-control" name="mobile"
                                    value="{{ $userData->mobile }}" id="mobile"
                                    placeholder="Product Phone" required>
                            ...
                            <div class="mb-5">
                                ...
                                <select class="form-select" name="roles" data-control="select2"
                                    ...
                                    @foreach($roles as $item)
                                        <option value="{{$item->id}}" {{$userData->hasRole($item->name) ? 'selected' : '' }}>{{ Str::title($item->name) }}</option
                                            >
                                    @endforeach
                                </select>
						...
						<div class="col-md-9">
                            <div class="mb-5">
                                <label for="address" class="form-label">User Details</label>
                                <textarea type="text" class="form-control" name="address"
                                    value="" id="address"
                                    placeholder="Enter User Details Address "ols="10" rows="7">{{$userData->address}}</textarea>
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true"
										...
										@if($userData->image != null)
											<div class="image-input-wrapper w-125px h-125px"
												style="background-image: url({{asset('backend/uploads/userRole/'.$userData->image)}});">
											</div>
										@else
											<div class="image-input-wrapper w-125px h-125px"
                    ...
                    <div class="row">
                        <div class="col-6">
                            <input type="submit" class="btn text-white" style="background-color: #2F4F4F" value="Update">
                        </div>
                    </div>

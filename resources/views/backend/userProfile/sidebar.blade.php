            ...
            " class="fw-bold fs-4">Profile</li>
              ...
              <div class="leads rounded">
                <div class="leads_profile text-center mb-3">
                  ...
                  <img src="{{ asset('backend/uploads/userProfile/'. Auth::guard()->user()->image) }}" alt="profile leads">
                  @else
                  <img src="{{asset('backend')}}/uploads/userProfile/default.png" alt="profile leads">
                  @endif

                  <a href="#" class="text-gray-800">{{ Auth::guard()->user()->name}}</a>
                </div>
                ...
                <div class="leads_user_info">
                  <div class="d-flex flex-stack fs-4 py-3">
                    ...
                    <span data-bs-toggle="tooltip" data-bs-trigger="hover" data-kt-initialized="1">
                        ...
                        <!-- <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#edittext">Edit</a> -->
                ...
                <div id="kt_user_view_details" class="collapse show" style="">
                  <div class="pb-5 fs-6">
                    <div class="d-flex align-items-center justify-content-between">
                      ...
                      <div class="text-gray-600">{{ Auth::guard()->user()->name}}</div>
                      </div>

                      <div class="d-flex align-items-center justify-content-between">
                        <div class="fw-bold mt-3">Email</div>
                      <div class="text-gray-600">{{ Auth::guard()->user()->email}}</div>
                      </div>

                      <div class="d-flex align-items-center justify-content-between">
                        <div class="fw-bold mt-3">Mobile</div>
                      <div class="text-gray-600">
                          <a href="tel:01774444002" class="text-gray-600 text-hover-primary">{{ Auth::guard()->user()->mobile}}</a>
                      </div>
                      </div>

...
@section('title') Bank System | Push Notification Create @endsection
@section('styles')
<style>
</style>
@endsection
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="card-body card p-3">
                                <div class="card-content custom-card-content-for-datatable pb-5 pt-2">
                                    <h2 class="card-title">Push Notification Create</h2>
                                ...
                                <form class="gy-1 pt-75" action="{{route('push-notification.store')}}" method="POST"
                                        ...
                                        <div class="col-md-6 mb-3 custom-select2-dropdown">
                                            <div class="single_input">
                                                ...
                                                <input type="text" placeholder="Sending Date" name="sending_date"
                                                    ...
                                                    onblur="inputValidator(this.value,'warnTextDate','text')" required>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="single_input">
                                                ...
                                                <input type="text" placeholder="Sending Time" name="sending_time"
                                                    ...
                                                    onblur="inputValidator(this.value,'warnTextTime','text')" required>
                                        ...
                                        <div class="col-12 mb-3 custom-select2-dropdown">
                                            <div class="single_input">
                                                ...
                                                <input onblur="inputValidator(this.value,'warnTextTitle','text')"
                                                    ...
                                                    name="notification_title" id="notification_title" required>

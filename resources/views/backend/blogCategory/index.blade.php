...
@section('title') Bank System | Blog Category List @endsection
@section('styles')
@endsection
@section('content')
...
<div id="content" class="content filter_3">
    <main>
        ...
        <div class="align-items-center p-2">
            <h3 class="breadcump-header">Blog Category <span class="divider"></span></h3>
                ...
                <div class="col-lg-12 table_wrap hide_scrollbar table_data">
                    <div class="card-body card" style="padding-bottom: 5px;">
                        ...
                        <div class="card-content custom-card-content-for-datatable pb-3 pt-2">
                            <h2 class="card-title">Blog Category List</h2>
                                    ...
                                    @if(isset($item) && $item != null)
                                        <tr>
                                           <td>
                                                ...
                                                <img class="custom-datatable-image" src="{{asset('backend/uploads/blogCategoryImage/thumbnail/'.$item->image)}}" />
                                                @else
                                            ...
                                            <td>
                                                <div class="row_title">
                                                    <strong><a href="#">{{$item->blog_category_name}}</a></strong>
                                                </div>
                                                <div class="row-actions">
                                                    <span><a href="#" data-bs-toggle="modal" data-bs-target="#update{{$item->id}}">Edit </a> | </span>
                                                    <span>
                                                        <a href="{{route('blog-category.destroy', $item->id)}}">
                                        ...
                                        <!-- {{-- //To update the Blog Category data... --}} -->
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-850px">
                                                <div class="modal-content rounded">
                                                    <div class="modal-header border-0 justify-content-between">
                                                        <h2 class="modal_head">Update Blog Category</h2>
                                                    ...
                                                    <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                        <form class="gy-1 pt-75" action="{{route('blog-category.update', $item->id)}}"
                                                            ...
                                                            <div class="row mt-4">
                                                                ...
                                                                <div class="col-md-12 mb-3">
                                                                    <div class="single_input">
                                                                        <label for="blog_category_name" class="fw-bolder mb-1">Category Name <span
                                                                        ...
                                                                        <input onblur="inputValidator(this.value,'warnTextComapny','text')" placeholder="Category Name"
                                                                            class="form-control" type="text" name="blog_category_name" id="blog_category_name"
                                                                            value="{{$item->blog_category_name}}" required>
                                                                ...
                                                                <div class="col-12 mb-3">
                                                                    <label for="uploadImage{{$item->id}}" class="fw-bolder mb-1">Category Image <span
                                                                            class="text-danger custom-required-font">(Required)</span></label>
                                                                    <div class="select_imgWith_preview">
                                                                        @if(isset($item->image) && $item->image != null)
                                                                        <img id="uploadPreview{{$item->id}}" src="{{asset('backend/uploads/blogCategoryImage/'.$item->image)}}" />
                                                                        @else
        ...
        <div class="modal fade" id="addData" tabindex="-1" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered mw-850px">
                <div class="modal-content rounded">
                    <div class="modal-header border-0 justify-content-between">
                        <h2 class="modal_head">Add Blog Category</h2>
                        <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                            <span class="svg-icon svg-icon-1">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1"
                    ...
                    <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                        <form class="gy-1 pt-75" action="{{route('blog-category.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12 mb-3 custom-select2-dropdown">
                                    <div class="single_input">
                                        ...
                                        <input onblur="inputValidator(this.value,'warnTextName','text')" placeholder="Category Name"
                                            class="form-control" type="text" name="blog_category_name" id="blog_category_name" required>

...
@section('title') Bank System | Note Update @endsection
@section('styles')
@endsection
@section('content')
  ...
  <div class="container-fluid">
    <div class="top_post d-flex align-items-center justify-content-between mb-3">
      <div class="d-flex align-items-center">
        <h3>Update Note<span class="divider"> |</span></h3><span class="nav_indicator"><a href="./index.html">Home</a>
          > Update Note</span>
      </div>
    </div>

    <form action="{{route('frontend-note.update', $frontendNote->id)}}" method="post">
      @csrf
      @method('put')
      <div class="row">
        <div class="col-md-9 mb-3">
          ...
          <div class="text_input mb-3">
            <div class="form-group">
              <label class="h5" for="description">Update Note</label>
              <textarea name="description" class="form-control" id="description" cols="30" rows="10">{!! $frontendNote->description !!}</textarea>
              ...
              <div class="row">
                ...
                <div class="col-md-12 mb-3 custom-select2-dropdown">
                  ...
                  <select id="description_type" class="form-control w-100" name="description_type" required>
                    ...
                    <option value="{{$item}}" {{$frontendNote->description_type == $item ? 'selected' : ''}}>{{$item}}</option>
                    @endif
                    @endforeach
                ...
                <div style="background-color: rgb(0 0 0 / 3%);" class="card-footer px-0 text-center">
                  <button onclick="return validate();" type="submit"
                    class="table_button add btn w-75 mt-3">Publish</button>
                </div>

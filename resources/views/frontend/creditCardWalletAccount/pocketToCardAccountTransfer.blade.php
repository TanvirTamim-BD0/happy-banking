...
@section('title') Pocket To Credit Card Account Transfer @endsection
@section('styles')
@endsection
@section('content')
...
<div class="h-100 container">
    ...
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <form class="card mb-3" action="{{route('webuser.pocket-to-credit-card-account-transfer',$accountData->id)}}"
                method="post">
                @csrf
                ...
                <input type="hidden" id="fromPocketAccountId" name="from_pocket_account_id" value="{{Auth::user()->id}}">

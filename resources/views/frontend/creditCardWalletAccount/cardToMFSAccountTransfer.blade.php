...
@section('title') Credit Card To MFS Transfer @endsection
@section('styles')
@endsection
@section('content')
...
<div class="h-100 container">
    ...
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <form class="card mb-3" action="{{route('webuser.credit-card-to-mfs-account-transfer',$accountData->id)}}"
                method="post">
                @csrf
                ...
                <div class="form-group custom-form-group">
                    <label class="custom-form-label" for="email">Mobile Wallet <span
                ...
                <div class="form-group custom-form-group">
                    <label class="custom-form-label" for="email">Account <span
                            class="custom-danger">(requierd)</span></label>
                    <div class="single_input custom-select2-dropdown">
                        <i class="fa-solid fa-coins"></i>
                        <select autocomplete="off" name="to_account_id" id="to_account_id" required
                            class="form-control">
                ...
                @if($accountData->is_dual_currency == true)
                <nav class="mb-3">
                    <div class="nav nav-tabs custom-transfer-acccount-tab gap-2 btn-no-color" id="nav-tab"
                        role="tablist">
                        <button class="text-white primary_btn nav-link active" id="nav-bdt-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-bdt" type="button" role="tab" aria-controls="nav-bdt"
                            aria-selected="true" onclick="changeCurrency('BDT Currency')">BDT
                            Currency </button>
                        <button class="text-white primary_btn nav-link" id="nav-usd-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-usd" type="button" role="tab" aria-controls="nav-usd"
                            aria-selected="false" onclick="changeCurrency('USD Currency')">USD Currency </button>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-bdt" role="tabpanel" aria-labelledby="nav-bdt-tab">
                        ...
                        <div class="form-group custom-form-group">
                            <label class="custom-form-label" for="email">BDT Amounts <span
                                    class="custom-danger">(requierd)</span></label>
                            <div class="single_input ">
                                <i class="fa-solid fa-bangladeshi-taka-sign"></i>
                                <input name="pay_amount_bdt" type="number" id="pay_amount_bdt"
                                    placeholder="BDT Amounts" step="0.01">
                    ...
                    <div class="tab-pane" id="nav-usd" role="tabpanel" aria-labelledby="nav-usd-tab">
                        ...
                        <div class="form-group custom-form-group">
                            <label class="custom-form-label" for="email">USD Amount <span
                                    class="custom-danger">(requierd)</span></label>
                            <div class="single_input ">
                                <i class="fa-solid fa-bangladeshi-taka-sign"></i>
                ...
                @else
                <div class="form-group custom-form-group">
                    <label class="custom-form-label" for="email">BDT Amount <span
                            class="custom-danger">(requierd)</span></label>
                    <div class="single_input ">
                        <i class="fa-solid fa-bangladeshi-taka-sign"></i>
                ...
                <div class="form-group custom-form-group">
                    <label class="custom-form-label" for="email">Note <span
                            class="custom-danger">(requierd)</span></label>
                    <div class="single_input"><textarea name="notes" type="text" id="notes" placeholder="Write Note"

...
@section('title') Bank To Credit Card Account Transfer @endsection
@section('styles')
@endsection
@section('content')
...
<div class="h-100 container">
    ...
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <form class="card mb-3" action="{{route('webuser.bank-to-credit-card-account-transfer',$accountData->id)}}"
                method="post">
                @csrf
                ...
                <label class="custom-form-label" for="email">From Bank <span class="custom-danger">(requierd)</span></label>
                <div class="single_input custom-select2-dropdown">
                    ...
                    <select autocomplete="off" name="bank_id" id="bank_id" required class="form-control">
                        <option value="" selected disabled>Select From Bank</option>
                ...
                <div class="form-group custom-form-group">
                    ...
                    <div class="single_input ">
                        <i class="fa-solid fa-bangladeshi-taka-sign"></i>
                        <input name="pay_amount" type="number" id="pay_amount" placeholder="BDT Amount" required>
        ...
        if (bankId != '') {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#from_account_id").append('<option value="" selected disabled>Select From Account</option>');

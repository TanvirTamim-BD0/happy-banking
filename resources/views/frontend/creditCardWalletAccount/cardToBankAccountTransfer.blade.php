...
@section('title') Credit Card To Bank Account Transfer @endsection
@section('styles')
@endsection
@section('content')
...
<div class="h-100 container">
    ...
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <form class="card mb-3" action="{{route('webuser.credit-card-to-bank-account-transfer',$accountData->id)}}"
                method="post">
                @csrf
                ...
                <nav class="mb-3">
                    <div class="nav nav-tabs custom-transfer-acccount-tab gap-2 btn-no-color" id="nav-tab" role="tablist">
                        <button class="text-white primary_btn nav-link active" id="nav-bdt-tab" data-bs-toggle="tab"
                            ...
                            Currency </button>
                        <button class="text-white primary_btn nav-link" id="nav-usd-tab" data-bs-toggle="tab" data-bs-target="#nav-usd"
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane" id="nav-usd" role="tabpanel" aria-labelledby="nav-usd-tab">
                        ...
                        <div class="form-group custom-form-group">
                            <label class="custom-form-label" for="email">1 USD In BDT <span
                                    class="custom-danger">(requierd)</span></label>
                            <div class="single_input ">
                                <i class="fa-solid fa-bangladeshi-taka-sign"></i>
                                <input name="usd_in_bdt_rate" type="number" id="usd_in_bdt_rate" step="0.01"
                                    placeholder="1 USD In BDT" onblur="converUSDToBDTCurrency()">
                ...
                <div class="single_input ">
                    <i class="fa-solid fa-bangladeshi-taka-sign"></i>
                    <input name="pay_fee" type="number" id="pay_fee" placeholder="Processing Fee(Max 5%)" onblur="checkProcessingFee()"
                    step="0.01" required>
                </div>
                </div>
...
<script>
    ...
    $("#bank_id").change(function () {
        var bankId = $(this).val();
        var url = "{{ route('webuser.get-account-data-with-bank-wise-for-credit-card') }}";
        if (bankId != '') {
            $.ajaxSetup({
                headers: {

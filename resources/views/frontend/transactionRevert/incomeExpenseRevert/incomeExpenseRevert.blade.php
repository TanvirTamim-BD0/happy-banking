...
@section('title') Income Expense Revert @endsection
@section('styles')
@endsection
@section('content')
...
<div class="h-100 container ">
    ...
    <form action="{{route('webuser.income-expense-revert-filter')}}" method="post" autocomplete="off" class="needs-validation card" style="margin-bottom: 13px;">
        @csrf

...
@section('title') Debit Transaction List Of Banking Wallet @endsection
@section('styles')
@endsection
@section('content')
...
<div class="h-100 container ">
    <div class="custom-transfer-acccount-tab gap-2 btn-no-color">
        <a href="{{route('webuser.banking-wallet-account-transaction-all-list', $accountId)}}" 
            class="text-white primary_btn nav-link">
            All
        </a>
    
        <a href="{{route('webuser.banking-wallet-account-transaction-credit-list', $accountId)}}"
            class="text-white primary_btn nav-link">
            Credit
        </a>
    
        <a href="{{route('webuser.banking-wallet-account-transaction-debit-list', $accountId)}}" 

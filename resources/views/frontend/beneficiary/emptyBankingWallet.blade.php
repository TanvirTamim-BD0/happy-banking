...
@section('title') Bank Beneficiary Accounts @endsection
@section('styles')
@endsection
@section('content')
...
<div class="container h-100 custom-main-container custom-empty-data-container">
    ...
    <div class="card text-center">
        ...
        <div class="mt-2">
            <a href="{{route('webuser.banking-beneficiary-account-create')}}">
    ...
    <div class="back-to-top">
        <div class="icon"><a href="{{route('webuser.banking-beneficiary-account-create')}}"><i

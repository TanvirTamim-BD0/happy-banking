...
@section('title') Banking Expense Create @endsection
@section('styles')
@endsection
@section('content')
...
<div class="h-100 container">
    ...
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            <form class="card mb-3" action="{{route('webuser.wallet-expense-save',['expense_type' => Crypt::encrypt("Banking Expense")])}}"
                method="post">
                @csrf

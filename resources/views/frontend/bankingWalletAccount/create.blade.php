...
@section('title') Create Banking Wallet Accounts @endsection
@section('styles')
@endsection
@section('content')
...
<div class="h-100 container">
    ...
    <form action="{{route('webuser.banking-wallet-account-store')}}" method="post" autocomplete="off" class="needs-validation card" style="margin-bottom: 13px;">
        @csrf
        <h4 class="text-center heading_text pb-3">Add Bank Account</h4>
        ...
        <div class="condition mt-3">
            <button type="submit" class="primary_btn mb-0">Add Bank Account</button>
        </div>
    </form>

...
<div class="h-100 container custom-main-container">
    ...
    <div class="pay_card_wrap">
        ...
        <a href="{{ route('webuser.bank-account-details', $account->id) }}">
            <div class="pay_card mb-3 card">
                ...
                <div class="d-flex align-items-center justify-content-between gap-2 custom-trans-bottom-block">
                    <a class="text-white w-50 primary_btn m-0" href="{{route('webuser.banking-wallet-account-transaction-all-list',$account->id)}}">Transaction</a>
                    <a class="text-white w-50 primary_btn m-0" href="{{route('webuser.payment-type-for-banking-wallet-account-transfer',$account->id)}}">Transfer</a>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="back-to-top">
        <div class="icon"><a href="{{route('webuser.banking-wallet-account-create')}}"><i class="fa-solid fa-plus"></i></a>
        </div>
    </div>
    @else

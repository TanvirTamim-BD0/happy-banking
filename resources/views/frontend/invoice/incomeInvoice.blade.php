            ...
            <div class="pay_card mb-3 card">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2 border-bottom pb-3">
                    ...
                    <div class="row w-100">
						...
						<div class="col-md-10">
							...
							<p class="text-dark font-13">Type : {{$result->income_expense_type}}</p>
						</div>
					</div>
                </div>
                ...
                <div class="d-flex align-items-center justify-content-between mb-2 pb-3">
                   <table class="table table-row-bordered">
                   		...
                   		<tr class="border">
                   			<td class="border-end">
                                <b class="custom-invoice-bold">Account Number</b> <br>
                                {{$fromAccount->account_number}}
								@if($fromAccount->bank_id != null)
								<span class="custom-invoice-root-bank">{{$fromAccount->bankData->bank_name}}</span>
								@else
								<span class="custom-invoice-root-bank">{{$fromAccount->mobileWalletData->mobile_wallet_name}}</span>
								@endif
                            </td>

							<td class="border-end">
								<b class="custom-invoice-bold">Income Type </b><br>
								{{$result->transactionCategoryData->category_name}}
							</td>
                   			
                   		</tr>
                   		<tr class="border">
                   			<td class="border-end">
                   				<b class="custom-invoice-bold">Income Balance</b><br>
                   				{{$result->amount}} BDT
                   			</td>
							
							<td class="border-end">
								<b class="custom-invoice-bold">Amount: </b>
								{{$result->amount}} BDT <br>

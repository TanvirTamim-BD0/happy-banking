...
@section('title') Pocket To Bank Account Transfer @endsection
@section('styles')
@endsection
@section('content')
...
<div class="h-100 container">
    ...
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            <form class="card mb-3" action="{{route('webuser.pocket-to-mfs-account-transfer')}}" method="post">
                @csrf
                ...
                <div class="single_input ">
                    ...
                    <input name="pay_amount" type="number" id="amount" placeholder="Enter Amount" step="0.01" required>
                </div>
                </div>
...
<script>
    ...
    $("#mobile_wallet_id").change(function () {
        ...
        var url = "{{ route('webuser.get-account-data-with-mobile-wallet-wise') }}";
        if (mobileWalletId != '') {
            $.ajaxSetup({
                headers: {

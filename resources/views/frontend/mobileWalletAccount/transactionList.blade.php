...
@section('title') Transaction Mobile Wallet Account list @endsection
@section('styles')
@endsection
@section('content')
                    ...
                    <div class="card transaction p-0 mb-3">
                        <div class="d-flex align-items-center justify-content-between p-2">
                            ...
                            <div class="d-flex flex-column custom-credit-debit-date-time">
                                <p class="text-secondary fw-light"><b>Date:</b> {{Carbon\Carbon::createFromFormat('Y-m-d', $item['date'])->format('d-m-Y')}} <br><b>Time:</b>
                ...
                @if(isset($item) && $item != null)
                    <div class="card transaction p-0 mb-3">
                        <div class="d-flex align-items-center justify-content-between p-2">
                            ...
                            <div class="d-flex flex-column custom-credit-debit-date-time">
                                <p class="text-secondary fw-light"><b>Date:</b> {{Carbon\Carbon::createFromFormat('Y-m-d', $item['date'])->format('d-m-Y')}} <br><b>Time:</b> {{$item['time']}}</p>
                            </div>
                        </div>
                        <div class="bg-secondary p-2">
                            <p class="h5 m-0">PWC: Pocket wallet credit thanks. </p>
